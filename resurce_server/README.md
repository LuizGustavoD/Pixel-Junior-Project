...
* **Fabrica de Aplicacao (App Factory)**: Modularizacao da inicializacao do framework. O arquivo `main.py` atua estritamente como iniciador de runtime, delegando a construcao e configuracao do Flask para o modulo `app_factory.py`.
